...
function abrirPopUpForm(json) {
    ...
    if (json != null) {
        ...
        $.get("Geografia/ObtenerPadres", function (data) {
            cargaComboSelec(json.Padre, data, document.getElementById("cboPadres"));
        });
    } else {
        $("#txtpais").val("");
        $("#txtcoordenadasx").val("");
        ...
        $("#txtpadre").val("");
        $.get("Geografia/ObtenerPadres", function (data) {
            cargaComboSelec("", data, document.getElementById("cboPadres"));
        });
    }
...
/*CARGA COMBO*/
/**/
function cargaComboSelec(value, data, control) {
        var contenido = "";
        var nfilas = Object.keys(data).length;
